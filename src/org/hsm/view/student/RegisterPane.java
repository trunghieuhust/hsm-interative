...
public class RegisterPane extends JPanel {
	...
	public RegisterPane() {
		...
		panel.add(comboBoxCourse, "4, 4, fill, default");
		...
		panel.add(comboBoxLecturer, "6, 4, fill, default");
		...
		panel.add(comboBoxRoom, "8, 4, fill, default");
